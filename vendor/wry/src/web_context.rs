...
/// # Warning
///
/// If [`WebView`] is created by a WebContext. Dropping `WebContext` will cause [`WebView`] to lose
/// some actions like custom protocol. Please keep both instances when you still wish to interact
/// with them.
///
...
pub struct WebContext {
	...
	#[allow(dead_code)] // It's not needed on Windows.
...
impl WebContext {
	...
	///
	/// **Note:** This is currently a no-op on Windows.
