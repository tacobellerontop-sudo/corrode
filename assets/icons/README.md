...
- `index.tsv`: icon name, tab, zero-based cell; SHA-256
  `b199bdc665146cc9d66c3847a3543752c0380e5a756e38282650e13204e69087`.
...
The `corrode-mark` cell is our own artwork, not an upstream icon: it is the solid silhouette of
the Corrode chat-wave from `assets/brand/corrode-mark.svg`, trimmed to its bounding box so it
