...
```sh
python3 -m venv /tmp/corrode-twemoji-venv
/tmp/corrode-twemoji-venv/bin/pip install Pillow==11.3.0
/tmp/corrode-twemoji-venv/bin/python tools/generate-twemoji.py
```
