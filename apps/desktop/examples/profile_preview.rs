...
> {
	let bytes: &[u8] = match id {
		"corrode-ocean" => include_bytes!("../../../extensions/ocean.corrode-extension"),
		"message-delete-protector" => include_bytes!(
			"../../../examples/extensions/packages/message-delete-protector.corrode-extension"
		),
		"corrode-midnight" => include_bytes!("../../../extensions/midnight.corrode-extension"),
		"corrode-rose" => include_bytes!("../../../extensions/rose.corrode-extension"),
		"corrode-forest" => include_bytes!("../../../extensions/forest.corrode-extension"),
		"corrode-latte" => include_bytes!("../../../extensions/latte.corrode-extension"),
		"golden-theme" => include_bytes!("../../../extensions/golden.corrode-extension"),
		"black-theme" => include_bytes!("../../../extensions/katana.corrode-extension"),
		"obsidian-theme" => include_bytes!("../../../extensions/obsidian.corrode-extension"),
		"teal-theme" => include_bytes!("../../../extensions/teal.corrode-extension"),
...
fn seed_catalog(extensions: &mut ui::ExtensionUi, themes: bool) {
	...
	{
		let (id, filename) = ("corrode-ocean", "ocean.png");
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	eframe::run_native(
		"Corrode · offline profile preview",
				...
				if page == "extensions" {
					...
					if theme_preview {
						...
						let package = extensions::parse_package(include_bytes!(
							"../../../extensions/katana.corrode-extension"
						))?;
					...
					if let Some(tab) = &theme_editor {
						let mut package = extensions::parse_package(include_bytes!(
							"../../../extensions/ocean.corrode-extension"
						))
