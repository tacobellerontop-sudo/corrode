...
license as Corrode. Generation command (FFmpeg is development-only, never bundled):
...
440 Hz mono AAC audio. It uses the same MIT OR Apache-2.0 license as Corrode,
