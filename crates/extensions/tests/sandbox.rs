...
fn returning(json: &str) -> Package {
	...
	plugin(&format!(
		...
		(func (export "corrode_alloc") (param i32) (result i32) (i32.const 0))
		(func (export "corrode_invoke") (param i32 i32) (result i64) (i64.const {})))"#,
...
fn rejects_imports_start_and_excessive_memory() {
	...
	let package = plugin(
		r#"(module (memory (export "memory") 257) (func (export "corrode_alloc") (param i32) (result i32) i32.const 0) (func (export "corrode_invoke") (param i32 i32) (result i64) i64.const 0))"#,
	);
...
fn fuel_interrupts_infinite_loop_and_memory_growth_traps() {
	for (body, expected) in [
		...
		let package = plugin(&format!(
			r#"(module (memory (export "memory") 1) (func (export "corrode_alloc") (param i32) (result i32) i32.const 0) (func (export "corrode_invoke") (param i32 i32) (result i64) {body}))"#
		));
...
fn diagnostics_distinguish_safe_runtime_input_and_output_failures() {
	let trap = plugin(
        ...
        (func (export "corrode_alloc") (param i32) (result i32) i32.const 0)
        (func (export "corrode_invoke") (param i32 i32) (result i64) unreachable))"#,
	);
	...
	let recursive = plugin(
        ...
        (func (export "corrode_invoke") (param i32 i32) (result i64) call $recurse))"#,
	);
...
fn rejects_oversized_or_invalid_pointers_and_json_responses() {
	for packed in [MAX_IO_BYTES as u64 + 1, (u32::MAX as u64) << 32 | 4] {
		let package = plugin(&format!(
			r#"(module (memory (export "memory") 1) (func (export "corrode_alloc") (param i32) (result i32) i32.const 0) (func (export "corrode_invoke") (param i32 i32) (result i64) i64.const {packed}))"#
		));
		assert!(invoke(&package, &input()).is_err());
	}
