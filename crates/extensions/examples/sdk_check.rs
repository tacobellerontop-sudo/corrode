...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	check_app_toolbox(
		...
		&parse_package(include_bytes!(
			"../../../examples/extensions/packages/app-toolbox.corrode-extension"
		))?,
	);
	check_app_toolbox(
		"app-toolbox/rebuilt",
	...
	check_guild_inspector(
		...
		&parse_package(include_bytes!(
			"../../../examples/extensions/packages/guild-inspector.corrode-extension"
		))?,
	);
	check_guild_inspector(
	...
	check_conversation_inspector(
		...
		&parse_package(include_bytes!(
			"../../../examples/extensions/packages/conversation-inspector.corrode-extension"
		))?,
	);
	check_conversation_inspector(
