...
mod member_tests {
	...
	fn avatars_recipients_and_permission_scoped_list_ids() {
		...
		let custom_emoji: MemberItem = decode(br#"{"member":{"user":{"id":"5","username":"Presence"},"presence":{"status":"online","activities":[{"type":4,"emoji":{"name":"corrode_wave","id":"9001"}}]}}}"#).unwrap();
