...
/// Which GPU Corrode renders on, mirroring the three choices desktop platforms already offer.
///
...
pub enum GpuPreference {
	/// Corrode picks: presentable adapters first, then the discrete GPU that usually drives
...
impl GpuPreference {
	...
	pub fn description(self) -> &'static str {
		match self {
			Self::Automatic => "Let Corrode choose the GPU that can draw this window.",
